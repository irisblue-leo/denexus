...
export default function CTASection() {
  ...
  return (
    <section className="py-16 sm:py-24 relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/4 w-8 h-8 bg-white/10 rounded-full animate-bounce-soft" />
      <div className="absolute top-1/3 right-1/4 w-6 h-6 bg-white/10 rounded-full animate-bounce-soft" style={{ animationDelay: "1s" }} />
