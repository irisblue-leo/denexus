...
export default function AuthPanel({ isOpen, onClose }: AuthPanelProps) {
  ...
  return (
    <>
      ...
      {/* Panel */}
      <div
        className={`fixed top-0 right-0 h-full w-full max-w-md bg-gradient-to-br from-slate-50 to-purple-50 dark:from-slate-900 dark:to-purple-950 z-50 shadow-2xl transition-transform duration-500 ease-out overflow-y-auto ${
      ...
      >
        ...
        <button
          onClick={onClose}
          className="absolute top-4 right-4 p-2 rounded-full hover:bg-white/50 dark:hover:bg-white/10 transition-colors z-10"
        >
        ...
        <div className="min-h-full flex flex-col items-center justify-center px-8 py-12">
          {/* Card */}
          <div className="w-full max-w-sm bg-white dark:bg-card rounded-2xl shadow-xl p-8 animate-scale-in">
            {/* Header */}
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {authMode === "login" && (
                <>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-4 py-3 bg-secondary/50 border border-border rounded-xl text-sm placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all"
                      />
                    </div>
                  </div>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full pl-10 pr-10 py-3 bg-secondary/50 border border-border rounded-xl text-sm placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all"
                        />
                        <button
                          type="button"
                  ...
                  {/* Verify code field (for SMS login) */}
                  {loginMethod === "sms" && (
                    <div>
                      <label className="block text-sm font-medium text-foreground mb-1.5">
                      ...
                      <div>
                        ...
                        <div className="flex gap-2">
                          <input
                            ...
                            onChange={handleInputChange}
                            placeholder={t("verifyCodePlaceholder")}
                            className="flex-1 px-4 py-3 bg-secondary/50 border border-border rounded-xl text-sm placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all"
                          />
                          <button
                            type="button"
                            onClick={handleSendCode}
